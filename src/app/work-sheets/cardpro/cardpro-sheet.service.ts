...
export class CardProSheetService{
    ...
    getCardProSheet(pageRequestModel: PageRequestModel) {
        this.httpClient.get(
          environment.baseUrl + "/cardpro/sheet?pageNumber=" + pageRequestModel.pageNumber + "&pageSize=" + pageRequestModel.pageSize,
          { observe: "response" }
         )
        .subscribe({
          next: (httpResponse) => {
